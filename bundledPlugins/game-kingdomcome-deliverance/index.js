...
function refreshModList(context, discoveryPath) {
    ...
    return Bluebird.reduce(enabled, (accum, mod) => {
        ...
        return getManuallyAddedMods(disabled, enabled, path.join(discoveryPath, modsPath(), MODS_ORDER_FILENAME), context.api)
            .then(manuallyAdded => {
...
function LoadOrderBase(props) {
    ...
    return React.createElement(MainPage, {}, React.createElement(MainPage.Body, {}, React.createElement(BS.Panel, { id: 'kcd-loadorder-panel' }, React.createElement(BS.Panel.Body, {}, React.createElement(FlexLayout, { type: 'row' }, React.createElement(FlexLayout.Flex, {}, React.createElement(DraggableList, {
        id: 'kcd-loadorder',
    ...
    })), React.createElement(FlexLayout.Flex, {}, React.createElement('div', {
        style: {
...
function main(context) {
    ...
    context.optional.registerCollectionFeature('kcd_collection_data', (gameId, includedMods) => genCollectionsData(context, gameId, includedMods), (gameId, collection) => parseCollectionsData(context, gameId, collection), () => Promise.resolve(), (t) => t('Kingdom Come: Deliverance Data'), (state, gameId) => gameId === GAME_ID, CollectionsDataView);
    context.once(() => {
