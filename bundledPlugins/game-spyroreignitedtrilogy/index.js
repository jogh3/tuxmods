...
function testSupportedContent(files, gameId) {
    ...
    if (supported && files.find(file => (path.basename(file).toLowerCase() === 'moduleconfig.xml')
...
function main(context) {
    ...
    context.registerInstaller('spyroreignitedtrilogy-mod', 25, toBlue(testSupportedContent), toBlue(installContent));
