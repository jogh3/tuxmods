...
class TW3LoadOrder {
    ...
    constructor(props) {
        ...
        this.usageInstructions = () => (_jsx(InfoComponent, { onToggleModsState: props.onToggleModsState }));
        this.customItemRenderer = (props) => {
            return (_jsx(ItemRenderer, { className: props.className, item: props.item }));
        };
        this.mApi = props.api;
    ...
    readableNames = { [UNI_PATCH]: 'Unification/Community Patch' };
...
export async function importLoadOrder(api, collectionId) {
