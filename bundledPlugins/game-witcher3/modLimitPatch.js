...
export class ModLimitPatcher {
    ...
    async ensureModLimitPatch() {
        ...
        if (mod === undefined) {
            try {
                ...
                mod = util.getSafe(this.mApi.getState(), ['persistent', 'mods', GAME_ID, modName], undefined);
            }
            catch (err) {
    ...
    getLimitText(t) {
        return t('Witcher 3 is restricted to 192 file handles which is quickly reached when '
            ...
            + 'the "Witcher 3 Mod Limit Patcher" mod and the original game executable will be restored.', { ns: I18N_NAMESPACE, replace: { bl: '[br][/br][br][/br]', br: '[br][/br]' } });
    }
    async queryPatch() {
...
//# sourceMappingURL=modLimitPatch.js.map