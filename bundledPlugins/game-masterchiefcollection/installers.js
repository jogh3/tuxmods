...
export async function testPlugAndPlayInstaller(files, gameId) {
...
export async function installPlugAndPlay(files, destinationPath) {
...
export async function installModConfig(files, destinationPath) {
...
export async function install(files, destinationPath) {
    const haloGames = identifyHaloGames(files);
