...
async function findGame() {
    ...
    if (storeGames.length > 1)
        log('debug', 'Mutliple copies of Oblivion found', storeGames.map(s => s.gameStoreId));
