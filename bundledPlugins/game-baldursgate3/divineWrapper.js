...
const concurrencyLimiter = new util.ConcurrencyLimiter(5, () => true);
...
export async function extractPak(api, pakPath, destPath, pattern) {
    return runDivine(api, 'extract-package', { source: pakPath, destination: destPath, expression: pattern });
}
export async function listPackage(api, pakPath) {
    let res;
    try {
...
//# sourceMappingURL=divineWrapper.js.map