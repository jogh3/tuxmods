...
export async function getLatestReleases(currentVersion) {
    if (GITHUB_URL) {
...
export async function checkForUpdates(api, currentVersion) {
...
export async function downloadDivine(api) {
